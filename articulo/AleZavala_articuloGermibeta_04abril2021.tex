...
\label{S:1}
%%
%%\par NOTA: HAY QUE CONSIDERAR QUE LA REVISTA A LA QUE 
%%SE VA A ENVIAR ES Computational Biology and Chemistry de Elsevier. \par 
%%PARTE DE LA INTRODUCCIÓN SE DEBE QUITAR C0NSIDERANDO QUE 
%%MUCHOS DE LOS LECTORES SABRÁN ACERCA DE PROTEÍNAS Y PUEDEN SER HASTA BIOINFORMÁTICOS. \par
%%
...
%. las ventajas que confiere la germibeta. Hacer énfasis en que la 
...
%%verificar: considerar pasar esta idea a la intro de dgbd más arriba
In this case, the distribution falls rapidly and with high $\beta$ values, 
the rank is minor in the distribution por lo qué...... 
%\citet{Tesis Cheko}, esto puede estar interesante pero hay que 
%ponerlo con más detalle, o bien explicarnos a los legos la importancia 
%de esta observación, incluso si no tiene una conexión biológica clara, 
%pensamos que la importancia fisico-matemática es importante en sí.
...
%%DE LAS GRÁFICAS ANTERIORES, CUÁL SERÍA LA DESCRIPCIÓN SERÍA Y 
